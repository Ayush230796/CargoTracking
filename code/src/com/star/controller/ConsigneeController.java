...
public class ConsigneeController {
	...
	public static ResultSet getAllConsignee()
	 {
	   try{
		   Connection cn=DBHelper.openConnection();
		 ResultSet rs=DBHelper.executeQuery(cn,"Select * from consignee");   
		   return(rs);
	   }catch(Exception e){
	...
	public static Consignee checkPassword(String aid,String password)
	{try{
	...
	{System.out.println("ConsigneeController:CheckPassword:"+e);
	return null;	
	}
	}	
