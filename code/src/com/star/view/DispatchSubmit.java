...
import com.star.controller.ConsignerController;
import com.star.controller.DispatchController;
...
public class DispatchSubmit extends HttpServlet {
	 ...
	 */
	    ...
	    D.setLatitude(request.getParameter("lat"));
	    D.setLongitude(request.getParameter("lon"));
        ...
        T.setLat(D.getLatitude());
        T.setLng(D.getLongitude());
        ...
        SmsServlet sms=new SmsServlet();
         ...
         sms.SendSms("COM3",Cr.getMobileno() ,"Your Product Has Been Dispatched..Ur Tracking is "+tid);
       Consignee Ce=new  Consignee();
       Ce=ConsigneeController.displayById(D.getConsignee_Id());
       System.out.print(Ce.getMobileno());
       sms.SendSms("COM3",Ce.getMobileno() ,"Your Product Has Been Dispatched..Ur Tracking is "+tid);
        }
        else
