...
import com.star.controller.EmployeeController;
...
public class CheckEmployeeLogin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Employee E=EmployeeController.checkPassword(aid, password);
			if(E!=null)
			{  HttpSession sesem=request.getSession();
			   sesem.putValue("SEMP", E);
			   sesem.putValue("LTIME", new java.util.Date());
			response.sendRedirect("EmployeeHome");
				
			}
			else
			{out.println("Invalid EmployeeID/Password");
